...
const Input = (props) => {
  ...
  return (
    <View 
      {...viewprops} 
      style={ isRegisterInput && value.length > 0 ? 
        { ...props.style, 
    ...
    >
      <SafeAreaView>
        <View style={compStyles.container}>
          ...
          />
          {
            value.length > 0 && isRegisterInput && props.secretWriting ? 
              seePassword ?
              <SvgIconProvider
                src='styles.eyePassword'
                strprops='color, px, top, left'
          ...
          {
            value.length > 0 && isRegisterInput ? 
              value.length > 0 && !dataMessage.hidden ? 
              <SvgIconProvider
